/*! For license information please see form-builder.min.js.LICENSE.txt */ ! function (e) {
    "use strict";
    ! function () {
        var t = {
                424: function (e, t, r) {
                    ...
                    e.exports = function (e) {
                        ...
                        return t.toString = function () {
                            ...
                            for (var d = 0; d < e.length; d++) {
                                var c = [].concat(e[d]);
                                o && l[c[0]] || (void 0 !== i && (void 0 === c[5] || (c[1] = "@layer".concat(c[5].length > 0 ? " ".concat(c[5]) : "", " {").concat(c[1], "}")), c[5] = i), r && (c[2] ? (c[1] = "@media ".concat(c[2], " {").concat(c[1], "}"), c[2] = r) : c[2] = r), n && (c[4] ? (c[1] = "@supports (".concat(c[4], ") {").concat(c[1], "}"), c[4] = n) : c[4] = "".concat(n)), t.push(c))
                            }
                        }, t
                    }
                },
                ...
                726: function (e, t, r) {
                    ...
                    e.exports = function (e, t, r) {
                        ...
                        function v(t) {
                            var r = s,
                                o = d;
                            return s = d = void 0, m = t, f = e.apply(o, r)
                        }
                        ...
                        function x(e) {
                            return u = void 0, g && s ? v(e) : (s = d = void 0, f)
                        }
                        ...
                        function A() {
                            ...
                            if (s = arguments, d = this, p = e, r) {
                                if (void 0 === u) return function (e) {
                                    return m = e, u = setTimeout(y, t), b ? v(e) : f
                                }(p);
                                if (h) return clearTimeout(u), u = setTimeout(y, t), v(p)
                            }
                            return void 0 === u && (u = setTimeout(y, t)), f
                        }
                        return t = i(t) || 0, o(r) && (b = !!r.leading, c = (h = "maxWait" in r) ? l(i(r.maxWait) || 0, t) : c, g = "trailing" in r ? !!r.trailing : g), A.cancel = function () {
                            void 0 !== u && clearTimeout(u), m = 0, s = p = d = u = void 0
                        }, A.flush = function () {
                            return void 0 === u ? f : x(n())
                        }, A
                    }
                },
                611: function (e) {
                    ...
                    e.exports = function (e) {
                        ...
                        e.exports = function (e) {
                            return new Promise((function (t, c) {
                                var f = e.data,
                                    u = e.headers;
                                o.isFormData(f) && delete u["Content-Type"];
                                ...
                                if (p.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), p.timeout = e.timeout, p[m] = function () {
                                    ...
                                    var v = r(20),
                                        w = (e.withCredentials || a(e.url)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : void 0;
                                    w && (u[e.xsrfHeaderName] = w)
                                }
                                if ("setRequestHeader" in p && o.forEach(u, (function (e, t) {
                                        void 0 === f && "content-type" === t.toLowerCase() ? delete u[t] : p.setRequestHeader(t, e)
                        ...
                        function p() {
                            f && d && (f = !1, d.length ? c = d.concat(c) : u = -1, c.length && m())
                        }
                ...
                892: function (e, t, r) {
                        ...
                        for (var r = {}, o = [], n = 0; n < e.length; n++) {
                            ...
                            var f = l(c),
                                u = {
                                    ...
                                    media: a[2],
                                    sourceMap: a[3]
                                }; - 1 !== f ? (i[f].references++, i[f].updater(u)) : i.push({
                                identifier: c,
                                updater: b(u, t),
                                references: 1
                            }), o.push(c)
                    ...
                    function b(e, t) {
                        ...
                        if (t.singleton) {
                            var i = m++;
                            r = p || (p = s(t)), o = f.bind(null, r, i, !1), n = f.bind(null, r, i, !0)
                        } else r = s(t), o = u.bind(null, r, t), n = function () {
                            ! function (e) {
                    ...
                    e.exports = function (e, t) {
                        ...
                        return function (e) {
                            if (e = e || [], "[object Array]" === Object.prototype.toString.call(e)) {
                                ...
                                for (var s = a(e, t), d = 0; d < r.length; d++) {
                                    var c = l(r[d]);
            ...
            function () {
                ...
                const i = {},
                    ...
                    d = function (e, t, r) {
                        ...
                        let n = ["none", "block"];
                        r && (n = n.reverse());
                        for (let r = e.length - 1; r >= 0; r--) - 1 !== e[r].textContent.toLowerCase().indexOf(t.toLowerCase()) ? (e[r].style.display = n[0], o.push(e[r])) : e[r].style.display = n[1];
                        return o
                    },
                    c = ["select", "checkbox-group", "checkbox", "radio-group", "autocomplete"],
                    f = new RegExp(`(${c.join("|")})`);
                class u {
                    constructor(e) {
                        return n(this, "stage", void 0), n(this, "controls", void 0), n(this, "formActions", void 0), n(this, "editorWrap", void 0), this.optionFields = c, this.optionFieldsRegEx = f, this.subtypes = l, this.empty = s, this.filter = d, i[e] = this, i[e]
                    }
                    onRender(e, t) {
                ...
                class m {
                    constructor(e) {
                        this.formData = {}, this.formID = e, this.layout = "", p[e] = this
                    }
                }
                var b = o(747),
                    h = o.n(b);
                ...
                var v = {
                    loaded: g("loaded"),
                    viewData: g("viewData"),
                    userDeclined: g("userDeclined"),
                    modalClosed: g("modalClosed"),
                    modalOpened: g("modalOpened"),
                    formSaved: g("formSaved"),
                    fieldAdded: g("fieldAdded"),
                    fieldRemoved: g("fieldRemoved"),
                    fieldRendered: g("fieldRendered"),
                    fieldEditOpened: g("fieldEditOpened"),
                    fieldEditClosed: g("fieldEditClosed"),
                    stageEmptied: g("stageEmptied")
                };
                const w = {
                    ...
                    backends: {
                        ...
                        dompurify: !!window.DOMPurify && (y = window.DOMPurify, y.setConfig({
                            SANITIZE_DOM: !1,
                ...
                var y;
                const x = (e, t) => {
                    if (0 === w.backendOrder.length) return !1;
                    const r = e.toLowerCase();
                    return t = t ? t + "" : "", r.startsWith("on") || ["form", "formaction"].includes(r) || t.trim().toLowerCase().startsWith("javascript:")
                };
                w.backends.fallback = function (t) {
                    const r = document.implementation.createHTMLDocument(""),
                        o = r.createElement("base");
                    o.href = document.location.href, r.head.appendChild(o);
                    const n = ["applet", "comment", "embed", "iframe", "link", "listing", "meta", "noscript", "object", "plaintext", "script", "style", "xmp"],
                        i = e.parseHTML(t, r, !1);
                    e(i).find("*").addBack().each(((t, r) => {
                        "#text" !== r.nodeName && (r.tagName && n.includes(r.tagName.toLowerCase()) ? r.parentElement ? r.parentElement.removeChild(r) : i.includes(r) && i.splice(i.indexOf(r), 1) : r.attributes && Array.from(r.attributes).forEach((t => {
                            x(t.name, t.value) && e(r).removeAttr(t.name)
                        })))
                    }));
                    const l = r.createElement("div");
                    return e(l).html(i), l.innerHTML
                };
                const A = e => {
                        const t = !!w.clobberingProtection.document && document,
                            r = !!w.clobberingProtection.form && document.createElement("form");
                        return t && e in t || r && e in r ? w.clobberingProtection.namespaceAttributes ? "user-content-" + e : void 0 : e
                    },
                    C = {
                        fallback: (e, t) => {
                            const r = w.backends.fallback,
                                o = "function" == typeof r;
                            return o && (t = r(t)), e.innerHTML = t, o
                        },
                        dompurify: (e, t) => {
                            const r = w.backends.dompurify;
                            return !(!1 === r || !r.isSupported || (e.innerHTML = r.sanitize(t), 0))
                        },
                        sanitizer: (e, t) => {
                            const r = w.backends.sanitizer;
                    ...
                    O = function (t, r, o) {
                        if (void 0 === o && (o = !1), !o) {
                            ...
                            return void 0 !== w.backendOrder.find((e => C[e](o, r))) ? ((t => {
                                e(t).find("*").each(((e, t) => {
                            ...
                            })(o), t.innerHTML = o.innerHTML, t) : (t.innerHTML = r, t)
                        }
                        t.textContent = r
                    },
                    k = ["events"],
                ...
                const T = function (e, t) {
                        ...
                        const r = "function" == typeof window.structuredClone ? window.structuredClone(e) : Object.assign({}, e),
                            o = [null, void 0, ""];
                        t && o.push(!1);
                        for (const e in r) o.includes(r[e]) ? delete r[e] : Array.isArray(r[e]) && (r[e].length || delete r[e]);
                        return r
                    },
                    D = function (e) {
                        return !["values", "enableOther", "other", "label", "subtype"].includes(e)
                    },
                    L = e => Object.entries(e).map((e => {
                        let [t, r] = e;
                        return D(t) && Object.values(R(t, r)).join("")
                    })).filter(Boolean).join(" "),
                    R = (e, t) => {
                        let r;
                        return e = M(e), t && (Array.isArray(t) ? r = G(t.join(" ")) : ("boolean" == typeof t && (t = t.toString()), r = G(t.trim()))), {
                            name: e,
                            value: t = t ? `="${r}"` : ""
                        }
                    },
                    I = e => e.reduce(((e, t) => e.concat(Array.isArray(t) ? I(t) : t)), []),
                    M = e => ({
                        className: "class"
                    } [e] || P(e)),
                    P = e => (e = (e = e.replace(/[^\w\s\-]/gi, "")).replace(/([A-Z])/g, (function (e) {
                        return "-" + e.toLowerCase()
                    }))).replace(/\s/g, "-").replace(/^-+/g, ""),
                    B = e => e.replace(/-([a-z])/g, ((e, t) => t.toUpperCase())),
                    F = function () {
                        let e, t = 0;
                        return function (r) {
                            const o = Date.now();
                            return o === e ? ++t : (t = 0, e = o), (r.type || P(r.label)) + "-" + o + "-" + t
                        }
                    }(),
                    H = e => void 0 === e ? e : [
                    ...
                    q = function (e, t, r) {
                        ...
                        const {
                            events: n
                        } = r, i = N(r, k), l = document.createElement(e), a = {
                            string: e => {
                                O(l, l.innerHTML + e)
                            },
                            object: e => {
                                ...
                                return l.appendChild(q(t, r, o))
                            },
                            node: e => l.appendChild(e),
                            array: e => {
                                for (let t = 0; t < e.length; t++) o = H(e[t]), a[o](e[t])
                            },
                            function: e => {
                                e = e(), o = H(e), a[o](e)
                            },
                        ...
                        for (const e in i)
                            if (i.hasOwnProperty(e)) {
                                const t = M(e);
                                let r = Array.isArray(i[e]) ? Q(i[e].join(" ").split(" ")).join(" ") : i[e];
                                if (x(t, r)) continue;
                                if ("boolean" == typeof r) {
                                    if (!0 === r) {
                                ...
                                } else "id" !== t && "name" !== t || (r = A(r)), void 0 !== r && l.setAttribute(t, r)
                            } return t && a[o](t), ((e, t) => {
                            if (t)
                    ...
                    z = e => {
                        ...
                        return X(t, (e => {
                            let o = t[e].value || "";
                            o.match(/false|true/g) ? o = "true" === o : o.match(/undefined/g) && (o = void 0), o && (r[B(t[e].name)] = o)
                        })), r
                    },
                    U = e => {
                        const t = [];
                    ...
                    $ = e => {
                        ...
                        if (t) {
                            ...
                            for (let t = 0; t < e.length; t++) {
                                ...
                                n && n.length && (o.values = U(n)), i && i.length && (o.userData = W(i)), r.push(o)
                            }
                        }
                        return r
                    },
                    ...
                    Q = e => e.filter(((e, t, r) => r.indexOf(e) === t)),
                    Z = (e, t) => {
                        const r = t.indexOf(e);
                        r > -1 && t.splice(r, 1)
                    },
                    Y = function (e, t) {
                        ...
                        const r = jQuery;
                        let o = [];
                        return Array.isArray(e) || (e = [e]), K(e) || (o = jQuery.map(e, (e => {
                            const r = {
                                dataType: "script",
                                cache: !0,
                                url: (t || "") + e
                    ...
                    _ = function (t, r) {
                        void 0 === r && (r = ""), Array.isArray(t) || (t = [t]), t.forEach((t => {
                            let o = "href",
                                n = t,
                                i = "";
                            if ("object" == typeof t && (o = t.type || (t.style ? "inline" : "href"), i = t.id, n = i || t.href || t.style, t = "inline" === o ? t.style : t.href), !K(n, "css")) {
                                if ("href" === o) {
                    ...
                    ee = e => e.replace(/\b\w/g, (function (e) {
                        return e.toUpperCase()
                    })),
                    te = (e, t) => {
                        const r = Object.assign({}, e, t);
                        for (const o in t) r.hasOwnProperty(o) && (Array.isArray(t[o]) ? r[o] = Array.isArray(e[o]) ? Q(e[o].concat(t[o])) : t[o] : "object" == typeof t[o] ? r[o] = te(e[o], t[o]) : r[o] = t[o]);
                        return r
                    },
                    re = (e, t, r) => t.split(" ").forEach((t => e.addEventListener(t, r, !1))),
                    oe = (e, t) => {
                        const r = t.replace(".", "");
                        for (;
                    ...
                    ie = e => e.replace(/\s/g, "-").replace(/[^a-zA-Z0-9[\]_-]/g, ""),
                    le = e => e.replace(/[^0-9]/g, ""),
                    ae = (e, t) => t.filter((function (e) {
                        return !~this.indexOf(e)
                    }), e),
                    se = /^col-(xs|sm|md|lg)-([^\s]+)/,
                    de = e => "string" == typeof e ? e.split(" ").filter((e => se.test(e) || e.startsWith("row-"))) : [],
                    ce = {
                        addEventListeners: re,
                        attrString: L,
                        camelCase: B,
                        capitalize: ee,
                        closest: oe,
                        ...
                        escapeAttr: G,
                        escapeAttrs: e => {
                            for (const t in e) e.hasOwnProperty(t) && (e[t] = G(e[t]));
                            return e
                        },
                        escapeHtml: J,
                        forceNumber: le,
                ...
                e.fn.swapWith = function (t) {
                    const r = this,
                        o = e(t),
                        n = e("<div>");
                    return r.before(n), o.before(r), n.before(o).remove(), r
                };
                var fe = ce;
                const ue = ["label", "type"];
                class pe {
                    constructor(e, t) {
                        ...
                        e.id || (e.name ? e.id = e.name : e.id = "control-" + Math.floor(1e7 * Math.random() + 1)), this.id = e.id, this.type = e.type, this.description && (e.title = this.description), pe.controlConfig || (pe.controlConfig = {});
                        const o = this.subtype ? this.type + "." + this.subtype : this.type;
                        this.classConfig = jQuery.extend({}, pe.controlConfig[o] || {}), this.subtype && (e.type = this.subtype), this.required && (e.required = "required", e["aria-required"] = "true"), this.disabled && (e.disabled = "disabled"), this.config = e, this.configure()
                    }
                    ...
                    static register(e, t, r) {
                        const o = r ? r + "." : "";
                        pe.classRegister || (pe.classRegister = {}), Array.isArray(e) || (e = [e]);
                        for (const r of e) - 1 === r.indexOf(".") ? pe.classRegister[o + r] = t : pe.error(`Ignoring type ${r}. Cannot use the character '.' in a type name.`)
                    }
                    static getRegistered(e) {
                        void 0 === e && (e = !1);
                        const t = Object.keys(pe.classRegister);
                        return t.length ? t.filter((t => e ? t.indexOf(e + ".") > -1 : -1 === t.indexOf("."))) : t
                    }
                    static getRegisteredSubtypes() {
                        const e = {};
                        for (const t in pe.classRegister)
                            if (pe.classRegister.hasOwnProperty(t)) {
                                const [r, o] = t.split(".");
                                if (!o) continue;
                                e[r] || (e[r] = []), e[r].push(o)
                            } return e
                    ...
                    static getClass(e, t) {
                        const r = t ? e + "." + t : e;
                        return pe.classRegister[r] || pe.classRegister[e] || pe.error("Invalid control type. (Type: " + e + ", Subtype: " + t + "). Please ensure you have registered it, and imported it correctly.")
                    }
                    static loadCustom(e) {
                        let t = [];
                        if (e && (t = t.concat(e)), window.fbControls && (t = t.concat(window.fbControls)), !this.fbControlsLoaded) {
                            for (const e of t) e(pe, pe.classRegister);
                    ...
                    static mi18n(e, t) {
                        ...
                        let o = r.i18n || {};
                        o = o[h().locale] || o.default || o;
                        const n = this.camelCase(e),
                            i = "object" == typeof o ? o[n] || o[e] : o;
                        if (i) return i;
                        let l = r.mi18n;
                        return "object" == typeof l && (l = l[n] || l[e]), l || (l = n), h().get(l, t)
                    }
                    static active(e) {
                    ...
                    on(e) {
                        const t = {
                            ...
                            render: e => {
                                ...
                                this.css && _(this.css), this.js && !K(this.js) ? Y(this.js).done(t) : t()
                            }
                        };
                        return e ? t[e] : t
                    }
                    ...
                    markup(e, t, r) {
                        return void 0 === t && (t = ""), void 0 === r && (r = {}), this.element = q(e, t, r), this.element
                    }
                    parsedHtml(e) {
                        return V(e)
                    }
                ...
                const me = (e, t) => {
                    ...
                    if (e.className) {
                        const o = de(e.className);
                        o && o.length > 0 && (r += ` ${o.join(" ")}`, Array.isArray(t) || (t = [t]), t.forEach((e => {
                            e.classList && e.classList.remove(...o), e.querySelectorAll("[class*=row-],[class*=col-]").forEach((e => {
                                e.classList && e.classList.remove(...o)
                            }))
                        })))
                    }
                    return r
                ...
                class be {
                    constructor(e, t, r, o) {
                        var n, i, l;
                        void 0 === t && (t = !1), void 0 === r && (r = !1), void 0 === o && (o = {}), this.preview = null !== (n = t) && void 0 !== n && n, this.disableHTMLLabels = null !== (i = r) && void 0 !== i && i, this.controlConfig = null !== (l = o) && void 0 !== l ? l : {}, this.templates = {
                            label: null,
                            help: null,
                    ...
                    configure() {}
                    build(e, t, r) {
                        this.preview && (t.name ? t.name = t.name + "-preview" : t.name = fe.nameAttr(t) + "-preview"), t.id = t.name, this.data = jQuery.extend({}, t), pe.controlConfig = this.controlConfig;
                        const o = new e(t, this.preview);
                        let n = o.build();
                        if ("object" == typeof n && n.field || (n = {
                                field: n
                            }), "string" == typeof n.field) {
                            const e = this.markup("div", n.field, {});
                            1 === e.childElementCount ? n.field = e.children.item(0) : n.field = Array.from(e.children)
                        }
                        const i = this.label(),
                            l = this.help();
                        let a;
                        a = r && this.isTemplate(r) ? r : this.isTemplate(n.layout) ? n.layout : "default";
                        const s = this.processTemplate(a, n.field, i, l);
                        return o.on("prerender")(s), s.addEventListener("fieldRendered", o.on("render")), s
                    }
                    label() {
                        const e = this.data.label || "",
                            t = [this.disableHTMLLabels ? document.createTextNode(e) : fe.parsedHtml(e)];
                    ...
                    processTemplate(e) {
                        ...
                        let n = this.templates[e](...r, this.data);
                        return n.jquery && (n = n[0]), n
                    }
                    markup(e, t, r) {
                        return void 0 === t && (t = ""), void 0 === r && (r = {}), fe.markup(e, t, r)
                    }
                }
                const he = () => null;
                h().addLanguage("en-US", {
                ...
                const Oe = ["values"],
                    ke = ["label", "events"],
                    je = ["actionButtons", "replaceFields"];
                ...
                class Se {
                    constructor(e, t, r) {
                        this.data = p[e], this.d = i[e], this.doCancel = !1, this.layout = t, this.handleKeyDown = this.handleKeyDown.bind(this), this.formBuilder = r, this.toastTimer = null
                    }
                    startMoving(e, t) {
                    ...
                    stopMoving(t, r) {
                        const o = this;
                        r.item.removeClass("moving"), o.doCancel && (r.sender && e(r.sender).sortable("cancel"), this.from.sortable("cancel")), o.save(), o.doCancel = !1
                    }
                    beforeStop(e, t) {
                        const r = this,
                            o = ye.opts,
                            ...
                            i = [];
                        r.stopIndex = t.placeholder.closest("ul.stage-wrap > *").index() - 1, !o.sortableControls && t.item.parent().hasClass("frmb-control") && i.push(!0), o.prepend && i.push(0 === r.stopIndex), o.append && i.push(r.stopIndex + 1 === n), r.doCancel = i.some((e => !0 === e))
                    }
                    getTypes(t) {
                        const r = {
                                type: t.attr("type")
                    ...
                    xmlSave(e) {
                        ...
                        t.forEach((e => {
                            ...
                            let r = [`<field ${n=Ee(e,Oe),Object.entries(n).map((e=>{let[t,r]=e;return`${P(t)}="${r}"`})).join(" ")}>`];
                            var n;
                            if (c.includes(e.type)) {
                                const e = t.map((e => q("option", e.label, e).outerHTML));
                                r = r.concat(e)
                            }
                            r.push("</field>"), o.push(r)
                        })), o.push("</fields>");
                        const n = q("form-template", I(o).join(""));
                            ...
                            X(t.childNodes, (function (t, r) {
                                ...
                                if (!i.hasClass("disabled-field")) {
                                    ...
                                    if (l = Object.assign({}, l, n.getAttrVals(t)), l.subtype)
                                        ...
                                        t && (l.value = t.getContent())
                                    }
                                    if (s.length && (l.role = s.join(",")), l.className = l.className || l.class, l.className && "true" == i.attr("addeddefaultcolumnclass") && 1 == i.closest(this.formBuilder.rowWrapperClassSelector).children().length && l.className.includes(ye.opts.defaultGridColumnClass)) {
                                        const e = de(l.className);
                                    ...
                                    l = T(l), l.type && l.type.match(o.optionFieldsRegEx) && (l.values = n.fieldOptionData(i)), r.push(l)
                                }
                            }))
                        }
                        return r
                    ...
                    getData(e) {
                        const t = this.data;
                        if (e || (e = ye.opts.formData), !e) return !1;
                        const r = {
                            xml: e => Array.isArray(e) ? e : $(e),
                            json: e => "string" == typeof e ? window.JSON.parse(e) : e
                        };
                        return t.formData = r[ye.opts.dataType](e) || [], t.formData
                    }
                    save(e) {
                        void 0 === e && (e = !1);
                        const t = this,
                        ...
                        return r.formData = n[ye.opts.dataType](e), document.dispatchEvent(v.formSaved), r.formData
                    }
                    incrementId(e) {
                    ...
                    getAttrVals(t) {
                        ...
                        return X(o, (t => {
                            const n = o[t],
                                i = B(n.getAttribute("name"));
                            r[i] = [
                                [n.attributes.contenteditable, () => "xml" === ye.opts.dataType ? J(n.innerHTML) : n.innerHTML],
                    ...
                    updatePreview(t) {
                        const r = this,
                            ...
                            n = t.attr("class"),
                            i = t[0];
                        if (n.includes("input-control")) return;
                        const l = t.attr("type"),
                            a = e(".prev-holder", i);
                        let d = Object.assign({}, r.getAttrVals(i), {
                            type: l
                        });
                        l.match(o.optionFieldsRegEx) && (d.values = [], d.multiple = e('[name="multiple"]', i).is(":checked"), e(".sortable-options li", i).each((function (t, r) {
                            const o = {
                            ...
                            d.values.push(o)
                        }))), d = T(d, !0), d.className = r.classNames(i, d), t.data("fieldData", d);
                        const c = r.formBuilder.controls.custom.lookup(d.type),
                            f = r.formBuilder.controls.custom.getClass(d.type),
                            u = c ? c.class : f || pe.getClass(d.type, d.subtype),
                            p = this.layout.build(u, d);
                        s(a[0]), a[0].appendChild(p), p.dispatchEvent(v.fieldRendered)
                    }
                    disabledTT(e) {
                        const t = e.querySelectorAll(".disabled-field");
                        X(t, (e => {
                            const r = t[e],
                                o = h().get("fieldNonEditable");
                            if (o) {
                                const e = q("p", o, {
                                    className: "frmb-tt"
                                });
                    ...
                    classNames(t, r) {
                        ...
                        if (s && i) {
                            for (let e = 0; e < a.length; e++) {
                                const t = new RegExp(`^${s}-(?:` + ve.btn.join("|") + ")$");
                                a[e].match(t) && a.splice(e, 1, s + "-" + i)
                            }
                            a.push(s + "-" + i), a.push(s)
                        }
                        const d = Q(a).join(" ").trim();
                        return o.value = d, d
                    }
                    closeConfirm(e, t) {
                        e || (e = document.getElementsByClassName("form-builder-overlay")[0]), e && a(e), t || (t = document.getElementsByClassName("form-builder-dialog")[0]), t && a(t), document.removeEventListener("keydown", this.handleKeyDown, !1), document.dispatchEvent(v.modalClosed)
                    }
                    handleKeyDown(e) {
                    ...
                    showOverlay() {
                        ...
                        return document.body.appendChild(e), e.classList.add("visible"), e.addEventListener("click", (e => {
                            let {
                                target: t
                            } = e;
                            return this.closeConfirm(t)
                    ...
                    confirm(e, t, r, o) {
                        ...
                        const d = q("div", [s, a], {
                            ...
                            c = q("div", [e, d], {
                                className: o = "form-builder-dialog " + o
                            });
                        ...
                        return c.style.left = r.pageX + "px", c.style.top = r.pageY + "px", document.body.appendChild(c), a.focus(), c
                    }
                    dialog(e, t, r) {
                        ...
                        this.showOverlay();
                        const i = q("div", e, {
                            className: r = "form-builder-dialog " + r
                        });
                        return t ? i.classList.add("positioned") : (t = {
                            pageX: Math.max(o, window.innerWidth || 0) / 2,
                            pageY: Math.max(n, window.innerHeight || 0) / 2
                        }, i.style.position = "fixed"), i.style.left = t.pageX + "px", i.style.top = t.pageY + "px", document.body.appendChild(i), document.dispatchEvent(v.modalOpened), -1 !== r.indexOf("data-dialog") && document.dispatchEvent(v.viewData), i
                    }
                    confirmRemoveAll(t) {
                        const r = this,
                        ...
                        l.length ? r.confirm(i.clearAllMessage, (() => {
                            r.removeAllFields.call(r, n), ye.opts.persistDefaultFields && ye.opts.defaultFields ? this.addDefaultFields() : ye.opts.notify.success(i.allFieldsRemoved), ye.opts.onClearAll()
                        }), d) : r.dialog(i.noFieldsToClear, d)
                    }
                    addDefaultFields() {
                        ye.opts.defaultFields.forEach((e => this.formBuilder.prepFieldVars(e))), this.d.stage.classList.remove("empty")
                    }
                    removeAllFields(e) {
                        const t = h().current,
                            r = ye.opts,
                            o = [];
                        e.querySelectorAll(this.formBuilder.fieldSelector).length && (r.prepend && o.push(!0), r.append && o.push(!0), o.some(Boolean) || (e.classList.add("empty"), e.dataset.content = t.getStarted), this.emptyStage(e))
                    }
                    emptyStage(e) {
                        s(e).classList.remove("removing"), e.dispatchEvent(v.stageEmptied), this.save()
                    }
                    stageIsEmpty() {
                        return 0 === e(this.d.stage).find("li").length
                    }
                    setFieldOrder(t) {
                        if (!ye.opts.sortableControls) return !1;
                        const r = window.JSON,
                            o = [];
                        return t.children().each(((t, r) => {
                            const n = e(r).data("type");
                            n && o.push(n)
                        })), Ce()("sessionStorage") && window.sessionStorage.setItem("fieldOrder", r.stringify(o)), o
                    }
                    closeAllEdit() {
                    ...
                    toggleEdit(t, r) {
                        ...
                        if (o) return e(o).hasClass("editing") ? this.closeField(t, r) : this.openField(t, r)
                    }
                    closeField(t, r) {
                        void 0 === r && (r = !0);
                        const o = this,
                        ...
                        const s = e(`#${t}`),
                            d = e(`#${t}-cont`);
                        d.append(s), this.removeContainerProtection(d.attr("id")), ye.opts.onCloseFieldEdit(i[0]), document.dispatchEvent(v.fieldEditClosed);
                        const c = s.find(".prev-holder"),
                            f = setTimeout((() => {
                                clearTimeout(f), o.tmpCleanPrevHolder(c).forEach((e => {
                                    if (e.columnInfo.columnSize) {
                                        const t = o.getBootstrapColumnClass(d.attr("class"));
                                        t !== e.columnInfo.columnSize && (d.removeClass(t).addClass(e.columnInfo.columnSize), o.tmpCleanPrevHolder(c))
                                    }
                                }))
                            }), 300);
                        return n
                    ...
                    openField(t, r) {
                        ...
                        return this.formBuilder.preserveTempContainers.push(s.attr("id")), a.insertAfter(d), this.formBuilder.currentEditPanel = n[0], ye.opts.onOpenFieldEdit(n[0]), document.dispatchEvent(v.fieldEditOpened), e(document).trigger("fieldOpened", [{
                    ...
                    stickyControls() {
                        ...
                        e(window).scroll((function (l) {
                            const a = e(l.target).scrollTop(),
                                ...
                                d = Object.assign({}, s, ye.opts.stickyControls.offset);
                            if (a > i) {
                                const e = {
                                        position: "sticky"
                                    },
                    ...
                    showData() {
                        const e = J(this.getFormData(ye.opts.dataType, !0)),
                            t = q("code", e, {
                                className: `formData-${ye.opts.dataType}`
                            });
                        this.dialog(q("pre", t), !1, "data-dialog")
                    }
                    removeField(t, r) {
                        void 0 === r && (r = 250);
                        let o = !1;
                        ...
                        if (!l.length) return ye.opts.notify.warning("No fields to remove"), !1;
                        if (!t) {
                            const e = [].slice.call(l).map((e => e.id));
                            ye.opts.notify.warning("fieldID required to remove specific fields."), ye.opts.notify.warning("Removing last field since no ID was supplied."), ye.opts.notify.warning("Available IDs: " + e.join(", ")), t = i.lastChild.id
                        }
                        const a = document.getElementById(t);
                        if (!a) return ye.opts.notify.warning("Field not found"), !1;
                        const s = e(a),
                            d = s.closest(this.formBuilder.rowWrapperClassSelector);
                        s.slideUp(r, (function () {
                            s.removeClass("deleting"), s.remove(), o = !0, n.save(), i.childNodes.length || (i.classList.add("empty"), i.dataset.content = h().current.getStarted)
                        }));
                        const c = Object.assign({}, ye.opts.typeUserEvents["*"], ye.opts.typeUserEvents[a.type]);
                        if (c && c.onremove && c.onremove(a), document.dispatchEvent(v.fieldRemoved), d.length) {
                    ...
                    processActionButtons(e) {
                        ...
                        let n = t;
                        const i = this.data;
                        n = n ? h().current[n] || n : o.id ? h().current[o.id] || ee(o.id) : "", o.id ? o.id = `${i.formID}-${o.id}-action` : o.id = `${i.formID}-action-${Math.round(1e3*Math.random())}`;
                        const l = q("button", n, o);
                        if (r)
                            for (const e in r) r.hasOwnProperty(e) && l.addEventListener(e, (t => r[e](t)));
                        return l
                    }
                    processSubtypes(e) {
                        const t = ye.opts.disabledSubtypes;
                        for (const t in e) e.hasOwnProperty(t) && pe.register(e[t], pe.getClass(t), t);
                        const r = pe.getRegisteredSubtypes(),
                            o = Object.entries(r).reduce(((e, r) => {
                                let [o, n] = r;
                                return e[o] = t[o] && ae(t[o], n) || n, e
                            }), {}),
                            n = {};
                        for (const e in o)
                    ...
                    editorUI(e) {
                        const t = this.d,
                            r = this.data,
                            o = e || r.formID;
                        t.editorWrap = q("div", null, {
                            id: `${r.formID}-form-wrap`,
                            className: `form-wrap form-builder formbuilder-embedded-bootstrap ${ne()}`
                        }), t.stage = q("ul", null, {
                            id: o,
                            className: `frmb stage-wrap ${r.layout.stage}`
                        }), t.controls = q("ul", null, {
                            id: `${o}-control-box`,
                            className: "frmb-control"
                        });
                        const n = this.formActionButtons();
                        t.formActions = q("div", n, {
                    ...
                    processOptions(e) {
                        ...
                        const l = [{
                            ...
                            events: {
                                click: e => {
                                    t.save(), ye.opts.onSave(e, t.data.formData)
                                }
                            }
                        }].concat(r);
                        return n.fields = n.fields.concat(o), n.disableFields = n.disableFields.concat(o.map((e => {
                            let {
                                type: t
                            } = e;
                            return t && t
                        }))), "xml" === n.dataType && (n.disableHTMLLabels = !0), ye.opts = Object.assign({}, {
                            actionButtons: l
                        }, {
                    ...
                    input(e) {
                        return void 0 === e && (e = {}), q("input", null, e)
                    }
                    getFormData(e, t) {
                    ...
                    tmpCleanPrevHolder(t) {
                        ...
                        function i(e) {
                            ...
                            if (void 0 !== t && !1 !== t) {
                                ...
                                e.attr("class", e.attr("class").replace("__fb-tmp-col-", "col-")), e.attr("class", e.attr("class").replace("__fb-tmp-row-", "row-")), e.attr("class", e.attr("class").replace("col-", "__fb-tmp-col-")), e.attr("class", e.attr("class").replace("row-", "__fb-tmp-row-"));
                                const n = {};
                    ...
                    tryParseColumnInfo(e) {
                        const t = {};
                        if (e.className) {
                            const r = de(e.className);
                            r && r.length > 0 && r.forEach((e => {
                                e.startsWith("row-") ? t.rowUniqueId = e.replace("row-", "").trim() : t.columnSize = e
                            }))
                        }
                        return t
                    }
                    removeContainerProtection(e) {
                        const t = this.formBuilder.preserveTempContainers.indexOf(e); - 1 !== t && this.formBuilder.preserveTempContainers.splice(t, 1)
                    }
                    toggleHighlight(e, t) {
                        void 0 === t && (t = 600), e.addClass("moveHighlight"), setTimeout((function () {
                            e.removeClass("moveHighlight")
                        }), t)
                    }
                    showToast(t, r) {
                        void 0 === r && (r = 3e3), null != this.toastTimer && (window.clearTimeout(this.toastTimer), this.toastTimer = null), this.toastTimer = setTimeout((function () {
                    ...
                    getBootstrapColumnValue(e) {
                        if (e) {
                            ...
                            if (t) return parseInt(t.split("-")[2])
                        }
                        return 0
                    }
                    getBootstrapColumnPrefix(e) {
                        if (e) {
                            const t = this.getBootstrapColumnClass(e);
                            if (t) return `${t.split("-")[0]}-${t.split("-")[1]}`
                        }
                        return ""
                    }
                    getBootstrapColumnClass(e) {
                        if (e) {
                            const t = e.split(" ").filter((e => se.test(e)));
                            if (t && t.length > 0) return t[0]
                        }
                        return ""
                    }
                ...
                const Ne = ["values", "type"];
                pe.register("autocomplete", class extends pe {
                    static get definition() {
                        return {
                            mi18n: {
                    ...
                    build() {
                        const e = this.config,
                            ...
                            i = {
                                focus: e => {
                                    const t = e.target.nextSibling.nextSibling,
                                        r = d(t.querySelectorAll("li"), e.target.value);
                                ...
                                input: e => {
                                    ...
                                    const r = d(t.querySelectorAll("li"), e.target.value);
                        ...
                        delete l.name;
                        const s = [this.markup("input", null, l), this.markup("input", null, a)],
                            c = t.map((e => {
                                const t = e.label,
                                    r = {
                                        events: {
                        ...
                        return s.push(this.markup("ul", c, {
                            id: `${o.id}-list`,
                ...
                pe.register("button", Te), pe.register(["button", "submit", "reset"], Te, "button");
                class De extends pe {
                    constructor(e, t, r) {
                    ...
                    build() {
                        let e = this.template;
                        if (!e) return pe.error(`Invalid custom control type '${this.type}'. Please ensure you have registered it correctly as a template option.`);
                ...
                pe.register("hidden", class extends pe {
                    build() {
                ...
                class Re extends pe {
                    build() {
                        ...
                        return n[t] && (o = n[t]), {
                            field: this.markup(o, fe.parsedHtml(this.label), r),
                            layout: "noLabel"
                        }
                    }
                }
                pe.register(["paragraph", "header"], Re), pe.register(["p", "address", "blockquote", "canvas", "output"], Re, "paragraph"), pe.register(["h1", "h2", "h3", "h4", "h5", "h6"], Re, "header");
                const Ie = ["values", "value", "placeholder", "type", "inline", "other", "toggle"],
                    Me = ["label"];
                ...
                pe.register(["select", "checkbox-group", "radio-group", "checkbox"], class extends pe {
                    static get definition() {
                        return {
                            inactive: ["checkbox"],
                            mi18n: {
                    ...
                    build() {
                        ...
                        if (delete d.title, r) {
                            ...
                            if (!f && a) {
                                ...
                                const t = {
                                    id: `${d.id}-other`,
                                    className: `${null!==(u=d.className)&&void 0!==u?u:""} other-option`,
                                    value: ""
                                };
                                let r = `formbuilder-${c}`;
                                l && (r += "-inline");
                                ...
                                const n = {
                                    ...
                                    a = [document.createTextNode(pe.mi18n("other")), this.markup("input", null, n)],
                                    s = this.markup("label", a, {
                                        for: o.id
                                    }),
                                    f = this.markup("div", [i, s], {
                                        className: r
                                    });
                                e.push(f)
                            }
                        }
                        return this.dom = "select" == i ? this.markup(c, e, T(d, !0)) : this.markup("div", e, {
                            className: i
                        }), this.dom
                    }
                    groupRequired() {
                                ...
                                ((e, t) => {
                                    [].forEach.call(e, (e => {
                                        t ? e.removeAttribute("required") : e.setAttribute("required", "required"), ((e, t) => {
                                            const r = pe.mi18n("minSelectionRequired", 1);
                ...
                pe.register(["text", "file", "date", "number"], Be), pe.register(["text", "password", "email", "color", "tel"], Be, "text"), pe.register(["date", "time", "datetime-local"], Be, "date"), pe.register(["number", "range"], Be, "number");
                const Fe = ["value"];
                class He extends pe {
                    static get definition() {
                        return {
                ...
                pe.register("textarea", He), pe.register("textarea", He, "textarea");
                const qe = ["value"];
                He.register("tinymce", class extends He {
                    configure() {
                        if (this.js = [], window.tinymce || this.js.push("https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.11/tinymce.min.js"), this.classConfig.js) {
                    ...
                    onRender() {
                        ...
                        const o = this.config.userData ? this.parsedHtml(this.config.userData[0]) : void 0,
                            n = window.lastFormBuilderCopiedTinyMCE ? this.parsedHtml(window.lastFormBuilderCopiedTinyMCE) : void 0;
                        window.lastFormBuilderCopiedTinyMCE = null;
                        const i = function (e) {
                            n ? e.setContent(n) : o && e.setContent(o)
                        };
                        setTimeout((() => {
                ...
                He.register("quill", class extends He {
                    configure() {
                        const e = {
                                modules: {
                                    toolbar: [
                            ...
                            [t, r] = fe.splitObject(this.classConfig, ["css", "js"]);
                        Object.assign(this, We(We({}, {
                            js: "https://cdn.quilljs.com/1.2.4/quill.js",
                            css: "https://cdn.quilljs.com/1.2.4/quill.snow.css"
                        }), t)), this.editorConfig = We(We({}, e), r)
                    }
                    build() {
                        const e = this.config,
                            {
                ...
                class $e {
                    ...
                    register(e, t) {
                        ...
                        const r = h().locale;
                        this.def.i18n[r] || (this.def.i18n[r] = {});
                        const o = this;
                        Object.keys(e).forEach((t => {
                            const r = function (r, o) {
                                this.customControl = new De(r, o, e[t]), this.build = function () {
                        ...
                        for (const o of t) {
                            ...
                            if (o.attrs = o.attrs || {}, !t) {
                                if (!o.attrs.type) {
                                    pe.error("Ignoring invalid custom field definition. Please specify a type property.");
                                    continue
                                }
                                t = o.attrs.type
                            }
                            ...
                            if (e[t]) {
                                ...
                                e.definition = o, this.customRegister[n] = jQuery.extend(o, {
                                    type: t,
                                    class: e
                                })
                            } else {
                                const e = pe.getClass(t, o.subtype);
                                if (!e) {
                                    super.error("Error while registering custom field: " + t + (o.subtype ? ":" + o.subtype : "") + ". Unable to find any existing defined control or template for rendering.");
                                    continue
                                }
                                n = o.datatype ? o.datatype : `${t}-${Math.floor(9e3*Math.random()+1e3)}`, this.customRegister[n] = jQuery.extend(o, {
                                    type: t,
                                    class: e
                                })
                            }
                            this.def.i18n[r][n] = o.label, this.def.icon[n] = o.icon
                        }
                    }
                    label(e) {
                        const t = this.definition;
                        let r = t.i18n || {};
                        r = r[h().locale] || r.default || r;
                        const o = pe.camelCase(e),
                            n = "object" == typeof r ? r[o] || r[e] : r;
                        if (n) return n;
                        let i = t.mi18n;
                        return "object" == typeof i && (i = i[o] || i[e]), i || (i = o), h().get(i)
                    }
                    get definition() {
                        return {}
                    }
                ...
                var Ve = JSON.parse('{"Rp":"formbuilder-icon-"}');
                const Je = Ve.Rp;
                class Ge {
                    constructor(e, t) {
                        this.opts = e, this.dom = t.controls, this.getRegistered = pe.getRegistered, this.init()
                    }
                    init() {
                    ...
                    setupControls() {
                        const e = this.opts;
                        pe.loadCustom(e.controls), this.custom = new $e(e.templates, e.fields);
                        const t = pe.getRegistered(),
                            r = this.custom.getRegistered();
                        r && jQuery.merge(t, r), this.registeredSubtypes = pe.getRegisteredSubtypes(), e.sortableControls && this.dom.classList.add("sort-enabled"), this.controlList = [], this.allControls = {};
                        for (let e = 0; e < t.length; e++) {
                            const r = t[e];
                            let o, n = this.custom.lookup(r);
                            if (n) o = n.class;
                            else if (n = {}, o = pe.getClass(r), !o || !o.active(r)) continue;
                            const i = n.icon || o.icon(r);
                            let l = n.label || o.label(r);
                            const a = i ? "" : n.iconClassName || `${Je+r.replace(/-[\d]{4}$/,"")}`;
                            i && (l = `<span class="control-icon">${i}</span>${l}`);
                            const s = q("li", q("span", l), {
                        ...
                        e.inputSets.length && e.inputSets.forEach(((e, t) => {
                            ...
                            r = r || P(o), e.icon && (o = `<span class="control-icon">${e.icon}</span>${o}`);
                            const n = q("li", q("span", o), {
                    ...
                    orderFields(e) {
                        ...
                        let o;
                        return Ce()("sessionStorage") && (t.sortableControls ? o = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), o ? (o = window.JSON.parse(o), o = Q(o.concat(e)), o = Object.keys(o).map((e => o[e]))) : o = Q(r), o.forEach((e => {
                    ...
                    appendControls() {
                        ...
                        s(this.dom), this.orderFields(this.controlList).forEach((t => {
                            const r = this.allControls[t];
                            r && e.appendChild(r)
                        })), this.dom.appendChild(e)
                    }
                    getClass(e, t) {
                        return this.custom.getClass(e) || pe.getClass(e, t)
                    }
                }
                const Xe = ["class", "className"],
                    Qe = ["multiple", "options", "label", "value", "class", "className"],
                    Ze = ["class", "className"],
                    Ye = ["tag", "content"],
                    Ke = ["i18n"];
                ...
                const rt = Ve.Rp,
                    {
                        rowWrapperClass: ot,
                        colWrapperClass: nt,
                        tmpRowPlaceholderClass: it,
                        invisibleRowPlaceholderClass: lt
                    } = xe,
                    {
                        rowWrapperClassSelector: at,
                        colWrapperClassSelector: st,
                        tmpRowPlaceholderClassSelector: dt,
                        invisibleRowPlaceholderClassSelector: ct
                    } = (ft = xe, Object.entries(ft).reduce(((e, t) => {
                        let [r, o] = t;
                        return S(S({}, e), {}, {
                            [`${r}Selector`]: `.${o}`
                        })
                ...
                function ut(e, t, o) {
                    const n = this,
                        ...
                        d = new u(l);
                    let c = [];
                    n.preserveTempContainers = [], n.rowWrapperClassSelector = at, n.colWrapperClassSelector = st, n.colWrapperClass = nt, n.fieldSelector = e.enableEnhancedBootstrapGrid ? at : "li.form-field", (e => {
                        ...
                        if (e.hasOwnProperty("clobberingProtection") && ["document", "form", "namespaceAttributes"].forEach((t => {
                                e.clobberingProtection.hasOwnProperty(t) && "boolean" == typeof e.clobberingProtection[t] && (w.clobberingProtection[t] = e.clobberingProtection[t])
                            })), e.hasOwnProperty("backends")) {
                            if ("object" != typeof e.backends) throw "backends config expected to be an Object";
                            Object.keys(e.backends).forEach((t => w.backends[t] = e.backends[t]))
                        }
                        if (e.hasOwnProperty("backendOrder")) {
                            if (w.backendOrder = [], !Array.isArray(e.backendOrder)) throw "backendOrder config expected to be an Array of backend keys as strings";
                            e.backendOrder.forEach((e => {
                                if (!w.backends.hasOwnProperty(e)) throw "unknown sanitizer backend " + e;
                                w.backendOrder.push(e)
                            }))
                        }
                    })(e.sanitizerOptions), o(t).closest("form").length && e.notify.warning("WARNING: FormBuilder does not support being contained with a <form> Element"), e.layout || (e.layout = be);
                    const f = new e.layout(e.layoutTemplates, !0, e.disableHTMLLabels, e.controlConfig),
                        p = new Se(l, f, n),
                        b = q;
                    e = p.processOptions(e), s.layout = p.editorLayout(e.controlPosition), p.editorUI(l), s.formID = l, s.lastID = `${s.formID}-fld-0`;
                    const g = new Ge(e, d);
                    n.controls = g;
                    const y = ye.subtypes = p.processSubtypes(e.subtypes),
                        x = o(d.stage),
                        A = o(d.controls);
                    let C, k, j = !1,
                        E = !1,
                    ...
                    x.sortable({
                        ...
                        opacity: .9,
                        revert: 150,
                        beforeStop: (e, t) => p.beforeStop.call(p, e, t),
                        start: (e, t) => p.startMoving.call(p, e, t),
                        stop: (e, t) => p.stopMoving.call(p, e, t),
                        change: function (t, r) {
                            e.prepend && r.placeholder.index() < 1 ? o("li.form-prepend").after(r.placeholder) : e.append && r.placeholder.index() >= x.children("li").length - 1 && o("li.form-append").before(r.placeholder)
                        },
                    ...
                    }), e.allowStageSort || x.sortable("disable"), A.sortable({
                        helper: "clone",
                        opacity: .9,
                        connectWith: `#${l}, ${at}`,
                        ...
                        update: function (t, r) {
                            if (p.doCancel) return !1;
                            o(r.item).closest(".stage-wrap") && 0 === o(r.item).closest(at).length ? (p.doCancel = !0, D(r.item)) : (N() && ue(), p.setFieldOrder(A), p.doCancel = !e.sortableControls)
                        }
                    }), A.on("mouseenter", (function () {
                        p.stageIsEmpty() || x.children(dt + ":not(:last-child)").addClass(lt)
                    }));
                    const D = t => {
                            if (t[0].classList.contains("input-set-control")) {
                                const r = [],
                                    o = e.inputSets.find((e => P(e.name || e.label) === t[0].dataset.type));
                                if (o && o.showHeader) {
                                    const e = {
                                        type: "header",
                                        subtype: "h2",
                                ...
                                r.push(...o.fields), r.forEach((e => {
                                    B(e, !0), (p.stopIndex || 0 === p.stopIndex) && p.stopIndex++
                                }))
                            } else B(t, !0)
                        },
                        R = o(d.editorWrap);
                    o('<div class="snackbar">').appendTo(R);
                    const I = b("div", d.controls, {
                        id: `${s.formID}-cb-wrap`,
                        className: `cb-wrap ${s.layout.controls}`
                    });
                    e.showActionButtons && I.appendChild(d.formActions);
                    const M = b("div", "", {
                        id: `${s.formID}-gridModeHelp`,
                        className: "grid-mode-help"
                    });
                    I.appendChild(M), R.append(d.stage, I), "textarea" !== t.type ? o(t).append(R) : o(t).replaceWith(R), o(d.controls).on("click", "li", (t => {
                        let {
                            target: r
                        } = t;
                        p.stageIsEmpty() && x.find(dt).eq(0).remove();
                        const n = o(r).closest("li");
                        p.stopIndex = e.append ? x.children().length - 1 : void 0, D(n), p.save.call(p)
                    }));
                    const B = function (t, r) {
                        ...
                        if (t instanceof jQuery)
                            if (n.type = t[0].dataset.type, n.type) {
                                const e = g.custom.lookup(n.type);
                                if (e) n = Object.assign({}, e);
                                else {
                                    const e = g.getClass(n.type);
                                    n.label = e.label(n.type)
                                }
                            } else {
                                const e = t[0].attributes;
                                r || (n.values = t.children().map(((e, t) => ({
                                    label: o(t).text(),
                                    value: o(t).attr("value"),
                                    selected: Boolean(o(t).attr("selected"))
                                }))));
                                for (let t = e.length - 1; t >= 0; t--) n[e[t].name] = e[t].value
                            }
                        else n = Object.assign({}, t);
                        n.name || (n.name = F(n)), r && ["text", "number", "file", "date", "select", "textarea", "autocomplete"].includes(n.type) && (n.className = n.className || "form-control");
                        const i = /(?:^|\s)btn-(.*?)(?:\s|$)/g.exec(n.className);
                        if (i && (n.style = i[1]), r) {
                            const e = setTimeout((() => {
                                document.dispatchEvent(v.fieldAdded), clearTimeout(e)
                            }), 10)
                        }
                        e.onAddField(s.lastID, n), ce(n, r), e.onAddFieldAfter(s.lastID, n), d.stage.classList.remove("empty")
                    };
                    n.prepFieldVars = B;
                    const z = function (t) {
                        (t = p.getData(t)) && t.length ? (t.forEach((e => U(e))), t.forEach((e => B(T(e)))), d.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? (ye.opts.defaultFields.forEach((e => U(e))), p.addDefaultFields()) : e.prepend || e.append || (d.stage.classList.add("empty"), d.stage.dataset.content = h().get("getStarted")), (() => {
                            const t = [],
                                r = t => b("li", e[t], {
                                    className: `disabled-field form-${t}`
                                });
                            return e.prepend && !o(".disabled-field.form-prepend", d.stage).length && (t.push(!0), x.prepend(r("prepend"))), e.append && !o(".disabled-field.form-append", d.stage).length && (t.push(!0), x.append(r("append"))), p.disabledTT(d.stage), t.some((e => !0 === e))
                        })() && d.stage.classList.remove("empty"), p.save()
                    };

                    function U(e) {
                        const t = p.getRowValue(e.className);
                        t && !c.includes(t) && c.push(t)
                    }
                    const W = t => {
                        const {
                            type: r
                        } = t, o = [], n = g.getClass(r), i = (e => {
                            const t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                                r = !["header", "paragraph", "file", "autocomplete"].concat(d.optionFields).includes(e),
                                o = {
                                    ...
                                    date: t.concat(["subtype", "min", "max", "step"]),
                                    file: t.concat(["multiple"]),
                                    header: ["label", "subtype", "className", "access"],
                                    hidden: ["name", "value", "access"],
                                    paragraph: ["label", "subtype", "className", "access"],
                                    number: t.concat(["subtype", "min", "max", "step"]),
                                    select: t.concat(["multiple", "options"]),
                                    textarea: t.concat(["subtype", "maxlength", "rows"])
                                };
                            e in g.registeredSubtypes && !(e in o) && (o[e] = t.concat(["subtype"])), o["checkbox-group"] = o.checkbox, o["radio-group"] = o.checkbox;
                            const n = o[e];
                            return "radio-group" === e && Z("toggle", n), ["header", "paragraph", "button"].includes(e) && Z("description", n), r || Z("value", n), n || t
                        })(r), l = {
                            required: () => de(t),
                            toggle: () => K("toggle", t, {
                                first: h().get("toggle")
                            ...
                            inline: () => {
                                const e = {
                                    first: h().get("inline"),
                                    second: h().get("inlineDesc", r.replace("-group", ""))
                                };
                                return K("inline", t, e)
                            },
                            label: () => se("label", t),
                            description: () => se("description", t),
                            subtype: () => ne("subtype", t, y[r]),
                            style: () => _(t.style),
                            placeholder: () => se("placeholder", t),
                            rows: () => te("rows", t),
                            className: e => se("className", t, e),
                            name: e => se("name", t, e),
                            value: () => se("value", t),
                            maxlength: () => te("maxlength", t),
                            access: () => {
                                const r = [`<div class="available-roles" ${t.role?'style="display:block"':""}>`];
                                for (a in e.roles)
                                    if (e.roles.hasOwnProperty(a)) {
                                        const t = `fld-${s.lastID}-roles-${a}`,
                                            o = {
                                                type: "checkbox",
                                                name: "roles[]",
                                                value: a,
                                        ...
                                        c.includes(a) && (o.checked = "checked"), r.push(`<label for="${t}">`), r.push(p.input(o).outerHTML), r.push(` ${e.roles[a]}</label>`)
                                    } r.push("</div>");
                                const o = {
                                    first: h().get("roles"),
                                    second: h().get("limitRole"),
                                    content: r.join("")
                                };
                                return K("access", t, o)
                            },
                            other: () => K("other", t, {
                                first: h().get("enableOther"),
                                second: h().get("enableOtherMsg")
                            }),
                            options: () => function (e) {
                                const {
                                    type: t,
                                ...
                                let o;
                                const n = [b("a", h().get("addOption"), {
                                        className: "add add-opt"
                                    })],
                                    i = [b("label", h().get("selectOptions"), {
                                        className: "false-label"
                                    })],
                                    l = e.multiple || "checkbox-group" === t,
                                    a = e => {
                                        const t = h().get("optionCount", e);
                                        return {
                                            selected: !1,
                                            label: t,
                                            value: P(t)
                                ...
                                const s = b("div", n, {
                                    ...
                                    d = b("ol", o.map((function (r, o, n, i) {
                                        void 0 === i && (i = e.name);
                                        const a = ye.opts.onAddOption(r, {
                                            type: t,
                                            index: o,
                                            isMultiple: l
                                        });
                                        return ke(i + "-options", a, l)
                                    })), {
                                ...
                                return i.push(c), b("div", i, {
                                    className: "form-group field-options"
                                }).outerHTML
                            }(t),
                            requireValidOption: () => K("requireValidOption", t, {
                                first: " ",
                                second: h().get("requireValidOption")
                            }),
                            multiple: () => {
                                const e = {
                                    default: {
                                    ...
                                    file: {
                                        first: h().get("multipleFiles"),
                                        second: h().get("allowMultipleFiles")
                                    },
                                    select: {
                                        first: " ",
                                        second: h().get("selectionsMessage")
                                    }
                                };
                                return K("multiple", t, e[r] || e.default)
                            }
                        };
                        let a;
                        const c = void 0 !== t.role ? t.role.split(",") : [];
                        ["min", "max", "step"].forEach((e => {
                            l[e] = "number" === r ? () => te(e, t) : () => se(e, t)
                        }));
                        const f = ["name", "className", "subtype"],
                            u = Object.assign({}, e.typeUserAttrs["*"], e.typeUserAttrs[r]);
                        if (Object.keys(i).forEach((t => {
                                ...
                                d && !f.includes(a) && s.push(!1), s.every(Boolean) && o.push(l[a](d))
                            })), n.definition.hasOwnProperty("defaultAttrs")) {
                            const e = G(n.definition.defaultAttrs, t);
                            o.push(e)
                        }
                        if (u) {
                            const e = G(u, t);
                    ...
                    function G(t, r) {
                        const o = [],
                            n = {
                                ...
                                boolean: (e, t) => {
                                    let o = !1;
                                    return "checkbox" === e.type ? o = Boolean(!!t.hasOwnProperty("value") && t.value) : r.hasOwnProperty(e) ? o = r[e] : (t.hasOwnProperty("value") || t.hasOwnProperty("checked")) && (o = t.value || t.checked || !1), K(e, tt(tt({}, t), {}, {
                                        [e]: o
                                    }), {
                                        first: i[e]
                                    })
                        ...
                        for (const l in t)
                            if (t.hasOwnProperty(l)) {
                                ...
                                if ("undefined" !== a) {
                                    const e = h().get(l),
                                        s = t[l],
                                        d = "boolean" === a ? s.value : s.value || "";
                                    s.value = r[l] || d, s.label && (i[l] = Array.isArray(s.label) ? h().get(...s.label) || s.label[0] : s.label), n[a] && o.push(n[a](l, s)), i[l] = e, s.value = d
                                } else if ("undefined" === a && J(r, l)) o.push(G(t[l], r));
                                else {
                                    const r = {};
                                    r[l] = t[l], e.notify.warning("Warning: unable to process typeUserAttr definition : " + JSON.stringify(r))
                                }
                            } return o.join("")
                    }
                    ...
                    function Q(e, t) {
                        ...
                        const a = `<label for="${l.id}">${i[e]||""}</label>`;
                        return ["checkbox", "checkbox-group", "radio-group"].includes(l.type) || l.className.push("form-control"), l = Object.assign({}, n, l), `<div class="form-group ${e}-wrap">${a}<div class="input-wrap">${(()=>{if("textarea"===l.type){const e=l.value;return delete l.value,`<textarea ${L(l)}>${e}</textarea>`}return` < input $ {
                            L(l)
                        } > `})()}</div></div>`
                    }
                    ...
                    function Y(e, t) {
                        const {
                            ...
                            class: a,
                            className: d
                        } = t, c = _e(t, Qe), f = Object.keys(o).map((e => {
                            const t = {
                                    value: e
                                },
                                r = o[e],
                                n = Array.isArray(r) ? h().get(...r) || r[0] : r;
                            return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), b("option", n, t)
                        })), u = {
                            id: `${e}-${s.lastID}`,
                            title: c.description || n || e.toUpperCase(),
                            name: e,
                            className: `fld-${e} form-control ${a||d||""}`.trim()
                        };
                        r && (u.multiple = !0);
                        const p = `<label for="${u.id}">${i[e]}</label>`;
                        return Object.keys(c).forEach((function (e) {
                            u[e] = c[e]
                        })), `<div class="form-group ${e}-wrap">${p}<div class="input-wrap">${b("select",f,u).outerHTML}</div></div>`
                    }
                    const K = function (e, t, r) {
                            ...
                            t[e] && (n.checked = !0);
                            const i = [];
                            let l = [b("input", null, n).outerHTML];
                            return r.first && i.push(o(r.first)), r.second && l.push(" ", o(r.second)), r.content && l.push(r.content), l = b("div", l, {
                                className: "input-wrap"
                            }).outerHTML, b("div", i.concat(l), {
                        ...
                        _ = e => {
                            ...
                            const r = `<label>${i.style}</label>`;
                            return t += p.input({
                                value: e || "default",
                                type: "hidden",
                                className: "btn-style"
                            }).outerHTML, t += '<div class="btn-group" role="group">', ve.btn.forEach((r => {
                                const o = ["btn-xs", "btn", `btn-${r}`];
                                e === r && o.push("selected");
                                const n = b("button", h().get(`styles.btn.${r}`), {
                                    value: r,
                                    type: "button",
                                    className: o.join(" ")
                                }).outerHTML;
                        ...
                        te = (e, t) => {
                            const {
                                class: r,
                                className: o
                            } = t, n = _e(t, Ze), i = isNaN(n[e]) ? void 0 : n[e], l = h().get(e) || e, a = {
                                type: "number",
                                value: i,
                                name: e,
                                placeholder: h().get(`placeholder.${e}`),
                                className: `fld-${e} form-control ${r||o||""}`.trim(),
                                id: `${e}-${s.lastID}`
                            }, d = p.input(T(a)).outerHTML;
                            return b("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${d}</div>`], {
                                className: `form-group ${e}-wrap`
                            }).outerHTML
                        },
                        ne = (e, t, r) => {
                            const o = r.map(((r, o) => {
                                    ...
                                    return r.value === t[e] && (n.selected = !0), n = T(n), b("option", n.label, n)
                                })),
                                n = {
                                    id: e + "-" + s.lastID,
                                    name: e,
                        ...
                        se = function (t, r, o) {
                            ...
                            let n = r[t] || "",
                                i = h().get(t) || t;
                            "label" === t && (["paragraph"].includes(r.type) ? i = h().get("content") : n = V(n));
                            const l = h().get(`placeholders.${t}`) || "";
                            let a = "";
                            if (![].some((e => !0 === e))) {
                                const d = {
                                        name: t,
                                ...
                                "label" !== t || e.disableHTMLLabels ? (d.value = n, d.type = "text", a += `<input ${L(d)}>`) : (d.contenteditable = !0, a += b("div", n, d).outerHTML);
                                const f = `<div class="input-wrap">${a}</div>`;
                                let u = o ? "none" : "block";
                                "value" === t && (u = r.subtype && "quill" === r.subtype && "none"), a = b("div", [c, f], {
                        ...
                        de = e => {
                            ...
                            let o = "";
                            return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some((e => !0 === e)) || (o = K("required", e, {
                                first: h().get("required")
                            })), o
                        },
                        ce = function (t, r) {
                            void 0 === r && (r = !0);
                            const l = Oe(t);
                            s.lastID = p.incrementId(s.lastID);
                            const a = t.type || "text";
                            let c = t.label || (r ? i[a] || h().get("label") : "");
                            var f;
                            "hidden" !== a && "" !== c || (c = `${null!==(f=h().get(a))&&void 0!==f?f:a}: ${t.name}`);
                            const u = e.disabledFieldButtons[a] || t.disabledFieldButtons;
                            let m = [b("a", null, {
                                type: "remove",
                                id: "del_" + s.lastID,
                                className: `del-button btn ${rt}cancel delete-confirm`,
                                title: h().get("removeMessage")
                            }), b("a", null, {
                                type: "edit",
                                id: s.lastID + "-edit",
                                className: `toggle-form btn ${rt}pencil`,
                                title: h().get("hide")
                            }), b("a", null, {
                                type: "copy",
                                id: s.lastID + "-copy",
                                className: `copy-button btn ${rt}copy`,
                                title: h().get("copyButtonTooltip")
                            })];
                            N() ? m.push(b("a", null, {
                                type: "grid",
                                id: s.lastID + "-grid",
                                className: `grid-button btn ${rt}grid`,
                                title: "Grid Mode"
                            })) : m.push(b("a", null, {
                                type: "sort",
                                id: s.lastID + "-sort-higher",
                                className: `sort-button sort-button-higher btn ${rt}sort-higher`,
                                title: "Move Higher"
                            }), b("a", null, {
                                type: "sort",
                                id: s.lastID + "-sort-lower",
                                className: `sort-button sort-button-lower btn ${rt}sort-lower`,
                                title: "Move Lower"
                            })), u && Array.isArray(u) && (m = m.filter((e => !u.includes(e.type))));
                            const g = [b("div", m, {
                                    className: "field-actions"
                                })],
                                v = e.disableHTMLLabels ? document.createTextNode(c) : V(c);
                            g.push(b("label", v, {
                            ...
                            const y = b("div", "", {
                                ...
                                dataFieldId: s.lastID
                            });
                            g.push(y);
                            const A = b("div", [W(t), b("a", h().get("close"), {
                            ...
                            const k = b("li", g, {
                                ...
                                T = o(k);
                            let D;
                            if (fe(T), T.data("fieldData", {
                                    attrs: t
                                }), void 0 !== p.stopIndex ? o(d.stage).children().eq(p.stopIndex).before(T) : x.append(T), o(".sortable-options", T).sortable({
                                    update: () => p.updatePreview(T)
                                }), p.updatePreview(T), N()) {
                                const e = `div.row-${l.rowUniqueId}`;
                                D = x.children(e).length ? x.children(e) : b("div", null, {
                                    id: `${k.id}-row`,
                                    className: `row row-${l.rowUniqueId} ${ot}`
                                }), j && E && (C.attr("id", D.id), C.attr("class", D.className), C.attr("style", ""), C.attr("data-row-id", l.rowUniqueId), D = C);
                                const t = b("div", null, {
                                    id: `${k.id}-cont`,
                                    className: `${l.columnSize} ${nt}`
                                });
                                j && S && ("true" == C.attr("prepend") ? o(t).prependTo(D) : o(t).insertAfter(`#${C.attr("appendAfter")}`)), S || o(t).appendTo(D), j || T.after(D), T.appendTo(t), he(D), pe(D), l.addedDefaultColumnClass && T.attr("addedDefaultColumnClass", !0), p.tmpCleanPrevHolder(o(y))
                            }
                            e.typeUserEvents[a] && e.typeUserEvents[a].onadd ? e.typeUserEvents[a].onadd(k) : e.typeUserEvents["*"] && e.typeUserEvents["*"].onadd && e.typeUserEvents["*"].onadd(k), r && (e.editOnAdd && (p.closeAllEdit(), p.toggleEdit(s.lastID, !1)), k.scrollIntoView && e.scrollToFieldOnAdd && k.scrollIntoView({
                                behavior: "smooth"
                            })), N() && j && S && Re(D, !0), j = !1, E = !1, S = !1
                        };

                    function fe(e) {
                        N() && e.mouseenter((function (e) {
                            De || (Ee = o(this), Ne = e.pageX, Te = e.pageY)
                        }))
                    }

                    function ue() {
                        x.find(dt + ":not(:last-child)").css("height", "1px").addClass(lt)
                    }

                    function pe(e) {
                        const t = o(e).clone();
                        if (t.addClass(lt).addClass(it).html(""), t.css("height", "1px"), t.attr("class", t.attr("class").replace("row-", "")), t.removeAttr("id"), 0 === o(e).index()) {
                            const e = o(t).clone();
                            x.prepend(e), he(e)
                        }
                        t.insertAfter(o(e)), he(t), x.find(at + ":last-child").removeClass(lt)
                    }

                    function me() {
                        x.children(dt).remove(), x.children(at).each(((e, t) => {
                            pe(o(t))
                        })), x.find(at + ":last-child").removeClass(lt)
                    }
                    ...
                    function he(t) {
                        ...
                        o(t).sortable({
                            ...
                            over: function (e) {
                                const t = o(e.target),
                                    r = t.hasClass(it);
                                r || Ae(t), t.addClass("hoverDropStyleInverse"), r || (ue(), t.prev(dt).removeClass(lt).css("height", "40px"), t.next(dt).removeClass(lt).css("height", "40px"))
                            },
                            out: function (e) {
                                x.children(dt).removeClass("hoverDropStyleInverse"), o(e.target).removeClass("hoverDropStyleInverse")
                            },
                            placeholder: "hoverDropStyleInverse",
                            receive: function (e, t) {
                                const r = o(t.sender).attr("id") === A.attr("id"),
                                    n = o(t.item).parent().hasClass(it),
                                    i = !n && o(t.item).parent().hasClass(ot);
                                if (n)
                                    if (r) E = !0, j = !0, C = o(t.item).parent();
                                    else {
                                        const e = o(t.item),
                                            r = Oe({}),
                                            n = b("div", null, {
                                                id: `${e.find("li").attr("id")}-row`,
                                                className: `row row-${r.rowUniqueId} ${ot}`
                                            });
                                        o(t.item).parent().replaceWith(n), fe(o(t.item)), e.appendTo(n), he(n), Ie(e.attr("id"))
                                    } if (i && r) {
                                    C = o(t.item).prev().hasClass("btnAddControl") ? o(t.item).prev() : o(t.item).next().hasClass("btnAddControl") ? o(t.item).next() : o(t.item).attr("prepend", "true");
                                    const e = p.getRowClass(o(t.item).parent().attr("class"));
                                    C.addClass(e), S = !0, j = !0, p.stopIndex = void 0
                                }
                                j && (p.doCancel = !0, D(t.item), p.save.call(p)), Me(), me();
                                const l = o(t.item).find("li");
                                l.length && (ge(l), we(l), p.tmpCleanPrevHolder(o(t.item).find(".prev-holder")))
                            },
                            start: (e, t) => {
                                x.addClass("__preventColButtons"), Ae(t.item.closest(at))
                            },
                            stop: (e, t) => {
                                x.removeClass("__preventColButtons"), x.children(dt).removeClass("hoverDropStyleInverse"), Re(t.item.closest(at), !0)
                            },
                            update: (e, t) => {
                                Ie(t.item.attr("id"))
                            }
                        });
                        const r = p.getRowValue(t.className);
                        "0" !== r && o(t).attr("data-row-id", r), xe(t, !0), e.enableColumnInsertMenu && (o(t).off("mouseenter"), o(t).on("mouseenter", (function (e) {
                            xe(o(e.currentTarget))
                        })), o(t).off("mouseleave"), o(t).on("mouseleave", (function (e) {
                            Ce(o(e.currentTarget))
                        })))
                    }
                    ...
                    function we(e) {
                        p.updatePreview(e), p.save.call(p)
                    }

                    function xe(t, r) {
                        if (void 0 === r && (r = !1), !e.enableColumnInsertMenu || x.hasClass("__preventColButtons")) return;
                        o(t).children("button.btnAddControl").remove();
                        const n = o(t).children(st);
                        n.each(((e, t) => {
                            const i = o(t);
                            i.addClass("colWithInsertButtons"), 0 === n.index(i) && o(`<button type="button" class="formbuilder-icon-plus btnAddControl ${p.getRowClass(i.parent().attr("class"))}" prepend="true" style='visibility: ${r?"hidden":"visible"}'></button>`).insertBefore(i), o(`<button type="button" class="formbuilder-icon-plus btnAddControl ${p.getRowClass(i.parent().attr("class"))}" appendAfter="${i.attr("id")}" style='visibility: ${r?"hidden":"visible"}'></button>`).insertAfter(i)
                        }))
                    }

                    function Ae(e) {
                        e.find("button.btnAddControl").remove(), e.find(st).removeClass("colWithInsertButtons")
                    }

                    function Ce(e) {
                        e.find("button.btnAddControl").css("visibility", "hidden")
                    }

                    function Oe(t) {
                        if (!N()) return {};
                        const r = p.tryParseColumnInfo(t);
                        if (!r.rowUniqueId) {
                            if (j && S) r.rowUniqueId = p.getRowValue(C.attr("class"));
                            else {
                                let e;
                                if (0 === c.length) e = 1;
                                else {
                                    const t = c.filter((e => !isNaN(e) && !isNaN(parseInt(e)))).map((e => parseInt(e)));
                                    e = Math.max(...t, 0) + 1
                                }
                                r.rowUniqueId = e.toString()
                            }
                            r.columnSize = e.defaultGridColumnClass, t.className || (t.className = ""), t.className += ` row-${r.rowUniqueId} ${r.columnSize}`, r.addedDefaultColumnClass = !0
                        }
                        return c.includes(r.rowUniqueId) || c.push(r.rowUniqueId), r
                    }
                    const ke = function (e, t, r) {
                            const o = {
                                ...
                                n = {
                                    boolean: (t, r) => {
                                        ...
                                        return t && (n.checked = !!t), n.name = e, ["input", null, n]
                                    },
                                    number: e => ["input", null, {
                                        value: e,
                                        type: "number"
                                    ...
                                    string: (e, t) => ["input", null, {
                                        value: e,
                                        type: "text",
                                        placeholder: h().get(`placeholder.${t}`) || ""
                                    }],
                                    array: e => ["select", e.map((e => {
                                        let {
                                            label: t,
                                            value: r
                                        } = e;
                            ...
                            const i = Object.entries(t).map((e => {
                                    let [t, r] = e;
                                    const o = H(r),
                                        [i, l, a] = n[o](r, t),
                                        s = `option-${t} option-attr`;
                                    return a["data-attr"] = t, a.className = a.className ? `${a.className} ${s}` : s, b(i, l, a)
                                })),
                                l = {
                                    className: `remove btn ${rt}cancel`,
                                    title: h().get("removeMessage")
                                };
                            return i.push(b("a", null, l)), b("li", i).outerHTML
                        },
                        je = [".form-elements input", ".form-elements select", ".form-elements textarea"].join(", ");
                    x.on("change blur keyup click", je, r()((e => {
                        if (e) {
                            if ([e => {
                                    let {
                                        type: t,
                            ...
                            we(o(e.target).closest(".form-field"))
                        }
                    }), 333, {
                        leading: !1
                    })), x.on("click touchstart", ".remove", (t => {
                        const r = o(t.target).parents(".form-field:eq(0)"),
                            n = r[0],
                            i = n.getAttribute("type"),
                            l = o(t.target.parentElement);
                        t.preventDefault(), n.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox") ? e.notify.error("Error: " + h().get("minOptionMessage")) : l.slideUp("250", (() => {
                            l.remove(), we(r)
                        }))
                    })), x.on("touchstart", "input", (e => {
                        const t = o(e.target);
                    ...
                    })), x.on("click touchstart", ".toggle-form, .close-field", (function (e) {
                        if (e.stopPropagation(), e.preventDefault(), !0 === e.handled) return !1; {
                            const t = o(e.target).parents(".form-field:eq(0)").attr("id");
                            p.toggleEdit(t), e.handled = !0
                        }
                    })), x.on("dblclick", "li.form-field", (e => {
                        if (!["select", "input", "label", "textarea"].includes(e.target.tagName.toLowerCase()) && !0 !== e.target.isContentEditable && (e.stopPropagation(), e.preventDefault(), !0 !== e.handled)) {
                            const t = o(e.target).closest("li.form-field").attr("id");
                            p.toggleEdit(t), e.handled = !0
                        }
                    })), x.on("change", '[name="subtype"]', (e => {
                        const t = o(e.target).closest("li.form-field");
                        o(".value-wrap", t).toggle("quill" !== e.target.value)
                    })), x.on("change", '[name="name"]', (t => {
                        const r = t.target.value;
                        (e => {
                            const t = document,
                                r = document.createElement("form");
                            return e in t || e in r
                        })(r) && e.notify.error("Potential for Dom Clobbering with field name " + r)
                    })), x.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (e => {
                        let t;
                        if (e.target.classList.contains("other-option")) return;
                        const r = oe(e.target, ".form-field");
                        if (["select", "checkbox-group", "radio-group"].includes(r.type)) {
                            ...
                            })) : (t = document.getElementsByName(e.target.name), X(t, (e => {
                                t[e].classList.contains("other-option") || (o[e].parentElement.childNodes[0].checked = t[e].checked)
                            })))
                        } else {
                        ...
                        p.save.call(p)
                    })), re(d.stage, "keyup change", (e => {
                        let {
                            target: t
                        } = e;
                        if (!t.classList.contains("fld-label")) return;
                        const r = t.value || t.innerHTML,
                            o = oe(t, ".form-field").querySelector(".field-label");
                        O(o, V(r), ye.opts.disableHTMLLabels)
                    })), x.on("keyup", "input.error", (e => {
                        let {
                            target: t
                        } = e;
                        return o(t).removeClass("error")
                    })), x.on("keyup", 'input[name="description"]', (function (e) {
                        const t = o(e.target).parents(".form-field:eq(0)"),
                            r = o(".tooltip-element", t),
                            n = o(e.target).val();
                        if ("" !== n)
                            if (r.length) r.attr("tooltip", n).css("display", "inline-block");
                            else {
                                const e = `<span class="tooltip-element" tooltip="${n}">?</span>`;
                                o(".field-label", t).after(e)
                            }
                        else r.length && r.css("display", "none")
                    })), x.on("change", ".fld-multiple", (e => {
                        const t = e.target.checked ? "checkbox" : "radio",
                            r = o(".option-selected", o(e.target).closest(".form-elements"));
                        return r.each((e => r[e].type = t)), t
                    })), x.on("blur", "input.fld-name", (function (e) {
                        e.target.value = ie(e.target.value), "" === e.target.value ? o(e.target).addClass("field-error").attr("placeholder", h().get("cannotBeEmpty")) : o(e.target).removeClass("field-error")
                    })), x.on("blur", "input.fld-maxlength", (e => {
                        e.target.value = le(e.target.value)
                    })), x.on("click touchstart", ".btnAddControl", (function (e) {
                        const t = o(e.currentTarget);
                        k = A.clone(), k.hover((function () {}), (function () {
                            k.remove()
                        })), k.on("click", "li", (e => {
                            let {
                                target: r
                            ...
                            S = !0, j = !0, C = t;
                            const n = o(r).closest("li");
                            p.stopIndex = void 0, D(n), p.save.call(p), k.remove()
                        })), x.append(k), 0 == t.index() ? k.css({
                            position: "fixed",
                            left: t.offset().left,
                            top: t.offset().top - o(window).scrollTop()
                        }) : k.css({
                            position: "fixed",
                            left: t.offset().left - 80,
                            top: t.offset().top - o(window).scrollTop()
                        });
                        const r = k.offset().top + k.outerHeight(),
                            n = o(window).scrollTop() + o(window).innerHeight();
                        r > n && k.css({
                            top: parseInt(k.css("top")) - (r - n)
                        })
                    })), x.on("click", `.${rt}copy`, (function (t) {
                        t.preventDefault();
                        const r = o(t.target).parent().parent("li"),
                            n = function (t) {
                                s.lastID = p.incrementId(s.lastID), ge(t);
                                const r = t.attr("id"),
                                    n = t.attr("type"),
                                    i = n + "-" + (new Date).getTime(),
                                    l = t.clone();
                                return o(".fld-name", l).val(i), l.find("[id]").each(((e, t) => {
                                    t.id = t.id.replace(r, s.lastID)
                                })), l.find("[for]").each(((e, t) => {
                                    const o = t.getAttribute("for").replace(r, s.lastID);
                                    t.setAttribute("for", o)
                                })), t.find("select").each((function (e) {
                                    l.find("select").eq(e).val(o(this).val())
                                })), l.attr("id", s.lastID), l.attr("name", i), l.addClass("cloned"), o(".sortable-options", l).sortable(), e.typeUserEvents[n] && e.typeUserEvents[n].onclone ? e.typeUserEvents[n].onclone(l[0]) : e.typeUserEvents["*"] && e.typeUserEvents["*"].onclone && e.typeUserEvents["*"].onclone(l[0]), l
                            }(r);
                        N() ? function (e, t) {
                            const r = o(`#className-${t.attr("id")}`),
                                n = Oe({}),
                                i = b("div", null, {
                                    id: `${e.attr("id")}-row`,
                                    className: `row row-${n.rowUniqueId} ${ot}`
                                }),
                                l = b("div", null, {
                                    id: `${e.attr("id")}-cont`,
                                    className: `${p.getBootstrapColumnClass(r.val())} ${nt}`
                                });
                            let a;
                            o(l).appendTo(i), t.parent().is("div") ? a = t.closest(at) : t.parent().is("ul") && (a = t), o(i).insertAfter(a), e.appendTo(l), he(i), me(), Ie(e.attr("id"))
                        }(n, r) : n.insertAfter(r), we(n), p.tmpCleanPrevHolder(n.find(".prev-holder")), e.editOnAdd && p.closeField(s.lastID, !1)
                    })), N() && x.on("stageEmptied", (() => {
                        c = []
                    })), x.on("click", ".delete-confirm", (t => {
                        t.preventDefault();
                        const r = t.target.getBoundingClientRect(),
                            n = document.body.getBoundingClientRect(),
                            i = {
                                pageX: r.left + r.width / 2,
                                pageY: r.top - n.top - 12
                            },
                            l = o(t.target).parents(".form-field:eq(0)").attr("id"),
                            a = o(document.getElementById(l));
                        if (document.addEventListener("modalClosed", (function () {
                                a.removeClass("deleting")
                            }), !1), e.fieldRemoveWarn) {
                            const e = b("h3", h().get("warning")),
                                t = b("p", h().get("fieldRemoveWarning"));
                            p.confirm([e, t], (() => p.removeField(l)), i), a.addClass("deleting")
                        } else p.removeField(l)
                    }));
                    let Ee, Ne, Te, De = !1,
                        Le = 0;
                    ...
                    function Re(e, t) {
                        void 0 === t && (t = !1);
                        const r = e.children(`div${st}`).length,
                            n = Math.floor(12 / r);
                        e.children(`div${st}`).each(((e, r) => {
                            const i = o(`#${r.id}`);
                            t || "true" != i.find("li").attr("manuallyChangedDefaultColumnClass") ? p.syncBootstrapColumnWrapperAndClassProperty(r.id.replace("-cont", ""), n) : p.showToast(`Preserving column size of field ${e+1} because you had personally adjusted it`, 4e3)
                        }))
                    }

                    function Ie(e) {
                        if (e) {
                            const t = o(`#className-${e.replace("-cont","")}`);
                            if (t.val()) {
                                const e = p.getRowClass(t.val()),
                                    r = p.getRowClass(t.closest(at).attr("class"));
                                t.val(t.val().replace(e, r)), Me()
                            }
                        }
                    }
                    ...
                    function Me() {
                        x.find(st).each(((e, t) => {
                            const r = o(t);
                            r.is(":empty") && !n.preserveTempContainers.includes(r.attr("id")) && r.remove()
                        })), x.children(at).not(dt).each(((e, t) => {
                            if (0 === o(t).children(st).length) {
                                const e = p.getRowValue(o(t).attr("class"));
                                c = c.filter((t => t !== e)), o(t).remove()
                            } else xe(o(t), !0)
                        }))
                    }

                    function Pe(e) {
                        if (void 0 === e && (e = !0), e) De = !0, p.showToast("Starting Grid Mode - Use the mousewheel to resize.", 1500), A.css("display", "none"), o(d.formActions).css("display", "none"), o(M).html("\n    <div style='padding:5px'>\n      <h3 class=\"text text-center\">Grid Mode</h3>    \n      \n      <table style='border-spacing:7px;border-collapse: separate'>\n        <thead>\n          <tr>\n            <th>Action</th>\n            <th>Result</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr>\n            <td><kbd>MOUSEWHEEL</kbd></td>\n            <td>Adjust the field column size</td>\n          </tr>    \n          <tr>\n            <td><kbd>W or &#x2191;</kbd></td> \n            <td>Move entire row up</td>\n          </tr>\n          <tr>\n              <td><kbd>S or &#x2193;</kbd></td> \n              <td>Move entire row down</td>\n          </tr>\n          <tr>\n              <td><kbd>A or &#x2190;</kbd></td>\n              <td>Move field left within the row</td>\n          </tr>\n          <tr>\n              <td><kbd>D or &#x2192;</kbd></td> \n              <td>Move field right within the row</td>\n          </tr>\n          <tr>\n            <td><kbd>R</kbd></td> \n            <td>Resize all fields within the row to be maximally equal</td>\n          </tr>\n          <tr>\n        </tbody> \n      </table>\n\n      <h5 class=\"text text-center\" style='padding-top:10px'>Current Row Fields</h5>    \n      \n      <table class='gridHelpCurrentRow'>\n        <colgroup>\n          <col width=\"100%\" />\n          <col width=\"0%\" />\n        </colgroup>\n        \n        <thead>\n          <tr>\n            <th>Field</th>\n            <th>Size</th>\n          </tr>\n        </thead>\n\n        <tbody>\n        </tbody> \n      </table>\n      \n    </div>\n    "), Be(), p.closeAllEdit(), p.toggleHighlight(Ee), ue();
                        else {
                            p.showToast("Grid Mode Finished", 1500);
                            const e = Ee.closest(at);
                            let t = 0;
                            e.children(`div${st}`).each(((e, r) => {
                                const n = o(`#${r.id}`).find("li").attr("id");
                                t += p.getBootstrapColumnValue(o(`#${n}-cont`).attr("class"))
                            })), t > 12 && Re(e, !0), De = !1, Ee = null, o(M).empty(), A.css("display", "unset"), o(d.formActions).css("display", "unset")
                        }
                    }

                    function Be() {
                        o(M).find(".gridHelpCurrentRow tbody").empty(), Ee.closest(at).children(`div${st}`).each(((e, t) => {
                            const r = o(`#${t.id}`).find("li").attr("id"),
                                n = o(`#${r}`),
                                i = n.attr("type");
                            let l = o(`#label-${r}`).html();
                            "hidden" !== i && "paragraph" !== i || (l = o(`#name-${r}`).val()), l || (l = n.attr("id"));
                            let a = "";
                            Ee.attr("id") === r && (a = "currentGridModeFieldHighlight"), o(M).find(".gridHelpCurrentRow tbody").append(`\n        <tr>\n          <td class='grid-mode-help-row1 ${a}'>${l}</td>\n          <td class='grid-mode-help-row2 ${a}'>\n            ${p.getBootstrapColumnValue(o(`#${r}-cont`).attr("class"))}\n          </td>\n        <tr>\n      `)
                        }))
                    }
                    if (x.on("click touchstart", ".grid-button", (e => {
                            e.preventDefault();
                            const t = o(e.target).parents(".form-field:eq(0)").attr("id");
                            Ee = o(document.getElementById(t)), Ne = e.pageX, Te = e.pageY, Le = 0, Pe()
                        })), x.on("wheel", (function (e) {
                            if (0 !== e.originalEvent.deltaY && De) {
                                e.preventDefault(), Le += e.originalEvent.deltaY;
                                const t = 120;
                                if (Le > 0 && Le < t || Le < 0 && Le > -t) return;
                                const r = Ee.closest("div"),
                                    n = p.getBootstrapColumnValue(r.attr("class")),
                                    i = Math.round(Le / t);
                                Le %= t;
                                const l = n + i;
                                if (l > 12) return void p.showToast('<b class="formbuilder-required">Column Size cannot exceed 12</b>');
                                if (l < 1) return void p.showToast('<b class="formbuilder-required">Column Size cannot be less than 1</b>');
                                const a = Ee.closest(at);
                                let s = l;
                                if (a.children(`div${st}`).each(((e, t) => {
                                        const r = o(`#${t.id}`).find("li").attr("id");
                                        r != Ee.attr("id") && (s += p.getBootstrapColumnValue(o(`#${r}-cont`).attr("class")))
                                    })), s > 12) return void p.showToast('<b class="formbuilder-required">There is a maximum of 12 columns per row</b>');
                                p.syncBootstrapColumnWrapperAndClassProperty(Ee.attr("id"), l), Ee.attr("manuallyChangedDefaultColumnClass", !0), Be(), p.toggleHighlight(Ee)
                            }
                        })), o(document).keydown((e => {
                            if (De) {
                                e.preventDefault();
                                const t = Ee.closest(at);
                                switch (event.code) {
                                    case "KeyW":
                                    case "ArrowUp":
                                        Ae(t),
                                            function (e) {
                                                const t = e.prevAll().not(dt).not(".form-prepend").first();
                                                t.length && (o(Ee.parent().parent()).swapWith(t), p.toggleHighlight(Ee))
                                            }(t);
                                        break;
                                    case "KeyS":
                                    case "ArrowDown":
                                        Ae(t),
                                            function (e) {
                                                const t = e.nextAll().not(ct).not(".form-append").first();
                                                t.length && (o(Ee.parent().parent()).swapWith(t), p.toggleHighlight(Ee))
                                            }(t);
                                        break;
                                    case "KeyA":
                                    case "ArrowLeft":
                                        Ae(t),
                                            function () {
                                                const e = Ee.parent().prev();
                                                e.length && Ee.parent().after(e), p.toggleHighlight(Ee)
                                            }();
                                        break;
                                    case "KeyD":
                                    case "ArrowRight":
                                        Ae(t),
                                            function () {
                                                const e = Ee.parent().next();
                                                e.length && Ee.parent().before(e), p.toggleHighlight(Ee)
                                            }();
                                        break;
                                    case "KeyR":
                                        Ae(t), Re(t, !0), xe(t, !0)
                        ...
                        })), o(document).mousemove((e => {
                            De && p.getDistanceBetweenPoints(Ne, Te, e.pageX, e.pageY) > ye.opts.cancelGridModeDistance && Pe(!1)
                        })), o(document).on("checkRowCleanup", ((e, t) => {
                            Me();
                            const r = o(`#${t.rowWrapperID}`);
                            r.length && Re(r, !0)
                        })), o(document).on("fieldOpened", ((e, t) => {
                            const r = o(`#${t.rowWrapperID}`);
                            r.length && Ce(r)
                        })), x.on("click", ".field-actions .sort-button", (function (e) {
                            e.preventDefault();
                            const t = o(e.target).parent().parent("li");
                            let r;
                            o(e.target).hasClass("sort-button-higher") ? (r = t.prev("li"), r.length && !r.hasClass("form-prepend") && t.insertBefore(r)) : (r = t.next("li"), r.length && !r.hasClass("form-append") && t.insertAfter(r)), p.toggleHighlight(t)
                        })), x.on("click", ".style-wrap button", (e => {
                            const t = o(e.target),
                                r = t.closest(".form-elements"),
                                n = t.val(),
                                i = o(".btn-style", r);
                            i.val(n), t.siblings(".btn").removeClass("selected"), t.addClass("selected"), we(i.closest(".form-field"))
                        })), x.on("click", ".fld-required", (e => {
                            o(e.target).closest(".form-field").find(".required-asterisk").toggle()
                        })), x.on("click", "input.fld-access", (function (e) {
                            const t = o(e.target).closest(".form-field").find(".available-roles"),
                                r = o(e.target);
                            t.slideToggle(250, (function () {
                                r.is(":checked") || o("input[type=checkbox]", t).removeAttr("checked")
                            }))
                        })), x.on("click", ".add-opt", (function (e) {
                            e.preventDefault();
                            const t = o(e.target).closest(".form-field").attr("type"),
                                r = o(e.target).closest(".field-options"),
                                n = o('[name="multiple"]', r),
                                i = o(".option-selected:eq(0)", r),
                                l = n.length ? n.prop("checked") : "checkbox" === i.attr("type"),
                                a = o(".sortable-options", r),
                                s = ye.opts.onAddOption({
                                    selected: !1,
                                    label: "",
                                    value: ""
                                }, {
                            ...
                            a.append(ke(i.attr("name"), s, l))
                        })), x.on("mouseover mouseout", ".remove, .del-button", (e => o(e.target).closest("li").toggleClass("delete"))), z(), !0 === e.disableInjectedStyle) {
                        const e = document.getElementsByClassName("formBuilder-injected-style");
                        X(e, (t => a(e[t])))
                    } else "bootstrap" === e.disableInjectedStyle && d.editorWrap.classList.remove("formbuilder-embedded-bootstrap");
                    return document.dispatchEvent(v.loaded), n.actions = {
                        getFieldTypes: t => t ? ae(g.getRegistered(), e.disableFields) : g.getRegistered(),
                        clearFields: () => p.removeAllFields(d.stage),
                        showData: p.showData.bind(p),
                        save: e => {
                            const t = p.save(e),
                                r = window.JSON.parse(t);
                            return ye.opts.onSave(r), r
                        },
                        addField: (e, t) => {
                            p.stopIndex = s.formData.length ? t : void 0, B(e)
                        },
                        removeField: p.removeField.bind(p),
                        getData: p.getFormData.bind(p),
                        setData: e => {
                            p.stopIndex = void 0, p.removeAllFields(d.stage), z(e)
                        },
                        setLang: e => h().setCurrent.call(h(), e).then((() => {
                            d.stage.dataset.content = h().get("getStarted"), g.init(), d.empty(d.formActions), p.formActionButtons().forEach((e => d.formActions.appendChild(e)))
                        })),
                        showDialog: p.dialog.bind(p),
                        toggleFieldEdit: e => {
                            (Array.isArray(e) ? e : [e]).forEach((e => {
                                ["number", "string"].includes(typeof e) && ("number" == typeof e ? e = d.stage.children[e].id : /^frmb-/.test(e) || (e = d.stage.querySelector(e).id), p.toggleEdit(e))
                            }))
                        },
                        toggleAllFieldEdit: () => {
                            X(d.stage.children, (e => {
                                p.toggleEdit(d.stage.children[e].id)
                            }))
                        },
                        closeAllFieldEdit: p.closeAllEdit.bind(p),
                        getCurrentFieldId: () => s.lastID
                    }, d.onRender(d.controls, (() => {
                        const t = setTimeout((() => {
                            d.stage.style.minHeight = `${d.controls.clientHeight}px`, e.stickyControls.enable && p.stickyControls(x), clearTimeout(t)
                        }), 0)
                    })), n
                }
                const pt = function (e, t) {
                    const r = this,
                        o = jQuery.extend({}, ge, e, !0),
                        {
                            i18n: n
                        } = o,
                        i = _e(o, Ke);
                    ye.opts = i, this.i18nOpts = jQuery.extend({}, we, n, !0);
                    const l = () => {
                        console.error("formBuilder is still initialising"), console.info("See https://formbuilder.online/docs/formBuilder/actions/getData/#wont-work and https://formbuilder.online/docs/formBuilder/promise/ for more information on formBuilder asynchronous loading")
                    };
                    this.instance = {
                        actions: ["getFieldTypes", "addField", "clearFields", "closeAllFieldEdit", "getData", "removeField", "save", "setData", "setLang", "showData", "showDialog", "toggleAllFieldEdit", "toggleFieldEdit", "getCurrentFieldId"].reduce(((e, t) => (e[t] = l, e)), {}),
                        markup: q,
                        get formData() {
                            return r.instance.actions.getData !== l && r.instance.actions.getData("json")
                        },
                        promise: new Promise((function (e, o) {
                            h().init(r.i18nOpts).then((() => {
                                const o = new ut(i, t[0], jQuery);
                                jQuery(t[0]).data("formBuilder", o), Object.assign(r.instance, o.actions), r.instance.actions = o.actions, delete r.instance.promise, e(r.instance)
                            })).catch((e => {
                                o(e), i.notify.error(e)
                            }))
                        }))
                    }
                };
                jQuery.fn.formBuilder = function (e) {
                    if (void 0 === e && (e = {}), "string" != typeof e) {
                        ...
                        return this.data("fbInstance", t.instance), t.instance
                    } {
                        const n = this.data("fbInstance");
                        if (n[e]) {
